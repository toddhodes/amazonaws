 ...
 *
 */
public class TerminateJobFlowsSample {
    ...
    public static void main(String... args) {
         ...
         * sample for Terminate Job Flows 
         ***********************************************************************/
     ...
     */
    public static void invokeTerminateJobFlows(AmazonElasticMapReduce service, TerminateJobFlowsRequest request) {
        try {
            
            TerminateJobFlowsResponse response = service.terminateJobFlows(request);

            
            System.out.println ("TerminateJobFlows Action Response");
            System.out.println ("=============================================================================");
            System.out.println ();

            System.out.println("    TerminateJobFlowsResponse");
            System.out.println();
