...
public class RunJobFlowSample {
     ...
     */
    public static void invokeRunJobFlow(AmazonElasticMapReduce service, RunJobFlowRequest request) {
        try {
            ...
            if (response.isSetRunJobFlowResult()) {
                ...
                System.out.println();
                RunJobFlowResult  runJobFlowResult = response.getRunJobFlowResult();
